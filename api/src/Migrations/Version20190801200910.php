...
final class Version20190801200910 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
		...
		$this->addSql('CREATE TABLE translations_article (id UUID NOT NULL, locale VARCHAR(8) NOT NULL, object_class VARCHAR(255) NOT NULL, field VARCHAR(32) NOT NULL, foreign_key VARCHAR(64) NOT NULL, content TEXT DEFAULT NULL, PRIMARY KEY(id))');
		$this->addSql('COMMENT ON COLUMN translations_article.id IS \'(DC2Type:uuid)\'');
		$this->addSql('CREATE INDEX article_translation_idx ON translations_article (locale, object_class, field, foreign_key)');
		$this->addSql('CREATE TABLE translations_text (id UUID NOT NULL, locale VARCHAR(8) NOT NULL, object_class VARCHAR(255) NOT NULL, field VARCHAR(32) NOT NULL, foreign_key VARCHAR(64) NOT NULL, content TEXT DEFAULT NULL, PRIMARY KEY(id))');
		$this->addSql('COMMENT ON COLUMN translations_text.id IS \'(DC2Type:uuid)\'');
		$this->addSql('CREATE INDEX text_translation_idx ON translations_text (locale, object_class, field, foreign_key)');
		$this->addSql('CREATE TABLE code_package (id UUID NOT NULL, article_id UUID DEFAULT NULL, PRIMARY KEY(id))');
		...
		$this->addSql('CREATE TABLE conference (id UUID NOT NULL, abstract TEXT NOT NULL, street VARCHAR(255) NOT NULL, date DATE NOT NULL, image VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, cp VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
		...
		$this->addSql('CREATE TABLE article (id UUID NOT NULL, image VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
		$this->addSql('CREATE UNIQUE INDEX UNIQ_23A0E66989D9B62 ON article (slug)');
		$this->addSql('COMMENT ON COLUMN article.id IS \'(DC2Type:uuid)\'');
		$this->addSql('CREATE TABLE text (id UUID NOT NULL, article_id UUID DEFAULT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
		...
		$this->addSql('CREATE TABLE site (id UUID NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
